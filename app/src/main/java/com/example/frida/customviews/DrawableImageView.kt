package com.example.frida.customviews
...
import com.example.frida.customviews.helpers.DrawableItem
import com.example.frida.customviews.helpers.Pen
import com.example.frida.customviews.helpers.Sticker
...
class DrawableImageView(context: Context, attrs: AttributeSet) :
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        Log.d(
            TAG,
            "Bitmap: ${bitmap?.width} ${bitmap?.height} ${this.width} ${this.height}"
        )
        Log.d(
            TAG,
